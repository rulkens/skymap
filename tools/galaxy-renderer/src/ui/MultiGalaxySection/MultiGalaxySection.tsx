 ...
 * Section-collapse chrome is the caller's concern — `ControlsPanel` wraps
 * this in a `CollapsibleSection`, so this component only owns what's
 * inside the body.
 *
 ...
 * `setExtras` call is `engineBridge`'s job, not this component's.
 */
