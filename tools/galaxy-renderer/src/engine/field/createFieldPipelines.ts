...
export type FieldPipelineDeps = {
  ...
  readonly tierUbo: Readonly<Record<HiiTierKind, GPUBuffer>>;
...
export type FieldPipelines = {
  ...
  hiiTierPipeline(kind: HiiTierKind): GPURenderPipeline;
  ...
  tierBG(kind: HiiTierKind): GPUBindGroup;
...
export function createFieldPipelines(deps: FieldPipelineDeps): FieldPipelines {
  ...
  let tierBGMap: Record<HiiTierKind, GPUBindGroup>;
