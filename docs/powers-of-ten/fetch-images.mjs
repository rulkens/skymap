...
const PLAN = {
  ...
  1: ["blue whale", GEN],
  0: ["human body anatomy", GEN],
  "-1": ["human hand", GEN],
  "-2": ["human skin macro", GEN],
  "-3": ["skin histology microscope", GEN],
  "-4": ["cells microscope fluorescence", GEN],
  "-5": ["neuron microscope", GEN],
  "-6": ["mitochondria cell organelle microscope", GEN],
