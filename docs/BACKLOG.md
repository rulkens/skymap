...
- [ ] **Distant-star flicker at planet zoom** `needs-design` — far famous stars (Deneb, Sadr) and their marker lines flicker at planet-scale camera distances; diagnose first — plausibly the NEAR0 depth bracket / clip-z clamps the star-slab item above would delete.
