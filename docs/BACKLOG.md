...
- [ ] **Atmosphere rows put colour in the wrong term** `ready` — four of six planets tint via `rayleighScatter` (Venus/Mars decrease toward blue; λ⁻⁴ can't), a workaround now that Mie is per-channel. → [details](backlog/2026-08-17-atmosphere-params-physical-channels.md)
