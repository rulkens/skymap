...
- [ ] **Wheel notch routed by last frame's winner** `ready` — a notch on a follow→spin hand-off frame is dropped, and one on the spin-off frame zooms a frozen base. → [details](backlog/2026-09-10-wheel-notch-route-by-last-winner.md)
