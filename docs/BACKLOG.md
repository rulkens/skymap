...
- [ ] **Render Sgr A* (black-hole close-up)** `blocked` — design settled in a grill session (cubemap geodesic pass, Schwarzschild, EHT-style glow); parked on the body-slab camera work. → [details](backlog/2026-09-01-render-black-hole.md)
...
- [ ] **Inside-atmosphere rendering** `needs-design` — the atmosphere shell vanishes the instant the camera enters it; needs an inside branch (sky dome, horizon haze, star washout) blending seamlessly at the crossing. → [details](backlog/2026-08-20-inside-atmosphere-rendering.md)
...
- [ ] **NEAR0 Label3D lift floor** `needs-verification` — confirm whether the spike's 1 pc lift-clearance floor lives in shared Label3D code or only its VR label producer. → [details](backlog/2026-08-23-near0-label-lift-floor.md)
