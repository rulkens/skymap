...
- [ ] **Tour opening retune for Earth-home boot** `needs-design` — the opening/closing beats were choreographed for the Milky-Way boot pose; boot now starts at Earth. → [details](backlog/2026-07-22-tour-opening-earth-start.md)
