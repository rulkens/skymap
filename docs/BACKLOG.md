...
- [ ] **Rhizome quick-look vs v9 epoch layout** `ready` — `--quick-look` still targets the v8 root; #545's hashed epoch/manifest flow strands it (safe but inert). → [details](backlog/2026-08-11-rhizome-quicklook-v9-epoch-alignment.md)
