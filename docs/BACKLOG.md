...
- [ ] **Surface-fixed mesh bodies need their own camera regime** `needs-design` — a rover's orbit rolls the horizon and dips under the ground, and the atmosphere composites over the rover; local-radial up, terrain floor, metre-scale drag. → [details](backlog/2026-09-12-rover-surface-camera-regime.md)
