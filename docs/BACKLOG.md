...
- [ ] **Tour-recorder follow-ups** `ready` — small post-merge items from the recorder's final review (tour-id-aware `--out` default, observable settle discard, two test/diagnostic tidies). → [details](backlog/2026-07-08-tour-recorder-follow-ups.md)
