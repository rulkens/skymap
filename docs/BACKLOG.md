...
- [ ] **General scale-fade bands** `ready` — one `fadeBand` primitive + declarative `SCALE_FADE_BANDS` table subsuming the MW approach fade, star-caption fade, and the new deep-zoom survey fade; design user-agreed. → [details](backlog/2026-07-13-scale-fade-bands.md)
