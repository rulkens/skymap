...
- [ ] **Selection ring should fade out once the focused body fills the view** `ready` — the ring is irrelevant when the body's disc reaches the screen edges (e.g. Earth at surface zoom); fade it smoothly as angular size approaches the viewport.
