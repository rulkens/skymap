...
- **Tour feature (full)** — finish the camera tour beyond the Part-2 stub. Tracked design: [splash-screen Part 2 stub-tour plan](superpowers/plans/2026-05-20-splash-screen-02-stub-tour.md) (ready to execute; verified current 2026-06-04) and [2026-05-07 tour-animation spec](superpowers/specs/2026-05-07-tour-animation-design.md) (re-grounded 2026-06-04; labels + MW impostor decisions resolved, cinematic palette documented). Resolve the spec's remaining open decisions (rotation slerp, caption producer, beat list/timing, engine API), promote to a plan, then implement the real waypoint tour.
