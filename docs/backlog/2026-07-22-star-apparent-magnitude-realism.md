...
- Brightness slider: `settings.starCatalogs.brightness` (`layers/starCatalog/state/starCatalogs/slice.ts:28-30`), Stars ▸ Advanced row (`StarsSection.tsx:223-242`, range 0.01–4), fed as `u.brightness` into `starPeakIntensity` — a pure gain on top of the exposure constant.
