...
| Stars (survey/near/famous) | real Pogson flux `10^(−0.4·absMag)` × inv-square × `STAR_FLUX_EXPOSURE=2400` × 6–28× camera ramp, compressed by `starKnee=8` | ~8 (post-knee)                                      | core yes, ×big eye-tuned fudge  | `lib/starPhotometry.wesl:119,145-147`; `starExposureRamp.ts`; `lib/starKnee.wesl:46`      |
