...
- **Task 1 spike decision:** _(filled by the spike task — mechanism chosen for tool-side resolution of `src/services/gpu/shaders/galaxyGen/`, what was tried, what failed.)_
