...
- [ ] On pass: mark PR #386 ready for review (`gh pr ready 386`), restate the three behaviour deltas (plan-time decision 3) in the PR body, and hand off per `superpowers:finishing-a-development-branch` / `/feature-done`. **(PARKED — user holding the un-draft.)**
