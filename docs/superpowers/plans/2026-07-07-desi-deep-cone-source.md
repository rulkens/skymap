...
- Modify: `README.md` — add an **Acknowledgements** section (new; none exists) carrying DESI DR1's required acknowledgment VERBATIM (fetched from data.desi.lbl.gov/doc/acknowledgments 2026-07-09, needed for the Zenodo DOI / JOSS): the paragraph beginning "This research used data obtained with the Dark Energy Spectroscopic Instrument (DESI). DESI construction and operations is managed by the Lawrence Berkeley National Laboratory. This material is based upon work supported by the U.S. Department of Energy, Office of Science, Office of High-Energy Physics, under Contract No. DE–AC02–05CH11231…" (full text in `data/raw/desi/README.md` after this task — single source, README quotes it in full), plus the required DR1 citation: DESI Collaboration et al. (2026), "Data Release 1 of the Dark Energy Spectroscopic Instrument", AJ 171, 285 (ads: 2026AJ....171..285D).
- Modify: `data/raw/desi/README.md` — add a "Required acknowledgment" section with the same verbatim paragraph + DR1 citation (provenance file = the canonical copy).
- Modify: `docs/BACKLOG.md` — add ONE terse `needs-design` line under Docs & process: acknowledgements for the OTHER surveys (SDSS, GLADE, 2MRS, CF4, Milliquas, MCPM VAC) are missing from README and each has official required wording to verify — pre-existing gap surfaced by the DESI DOI work. `CITATION.cff` intentionally unchanged (it cites skymap, not datasets).
