...
- [x] **Step 1:** Create the ADR via the `/adr` skill (or copy the template of the most recent ADR, e.g. `docs/adrs/0003-cluster-catalog-loading.md`), titled "Famous-galaxy calibration storage".
- [x] **Step 2:** Fill the sections:
...
- [x] **Step 3:** Cross-link the spec (`docs/superpowers/specs/2026-05-31-famous-galaxy-thumbnail-calibration-design.md`).
- [x] **Step 4: Commit**
