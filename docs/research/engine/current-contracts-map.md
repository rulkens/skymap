...
| wake                            | 🟠 10-term disjunction + explicit `anim` bag (3 fields) fed by planners                                                                                                                                                               | `shouldKeepTicking.ts:116-134`                                 |
...
| 🟠  | Wake terms accrete by hand (each = a signature edit) — ruled ACCEPTED, not open (rung 5, #15 D4): the signature edit is the compile-time gate against a dropped vote | `shouldKeepTicking.ts:19-29`                           |
