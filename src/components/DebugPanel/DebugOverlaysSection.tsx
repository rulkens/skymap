 ...
 * thumbnail's disk-radius footprint. Both used to sit as bare `<label>`s
 * directly in `DebugPanel` — this section gives them the same collapsible
 * chrome as the panel's other toggle groups.
 */
