/**
 * solarSystem — the orrery exhibit: orbit rings and planets, framed from above
 * the ecliptic. Unlike the two field exhibits this one authors no look, only a
...
export const solarSystem: Exhibit = {
  id: 'solarSystem',
  label: 'Solar System',
