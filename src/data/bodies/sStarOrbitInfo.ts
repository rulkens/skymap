...
import { SGR_A_STAR_SCHWARZSCHILD_RADIUS_MPC } from './sgrAStarSchwarzschildRadiusMpc';
...
const SCHWARZSCHILD_RADIUS_AU = SGR_A_STAR_SCHWARZSCHILD_RADIUS_MPC / SCALE_UNITS.AU_TO_MPC;
