 ...
 *   scene. `1.0` starts neutral; the visual pass nudges it so the blue limb and
 *   the reddened terminator arc read at a plausible strength against the
 *   tonemapped Earth rather than blowing out or washing to grey.
 */
