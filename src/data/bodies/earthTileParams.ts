...
/** Shallowest level the virtual texture ever requests. `z = 4` IS the base
 *  texture, so baking or fetching it would be re-downloading an image already
 *  bound. (Design 6.) */
export const EARTH_TILE_MIN_LEVEL = 5;
