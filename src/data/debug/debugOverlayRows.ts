...
//
// `earth-lod-overlay` (the page-table pyramid-level tint) was removed here
// when Task 5 deleted the page table it visualised — no per-fragment
// residency source is left in `earth/fragment.wesl` to tint.
