/**
 * CORE_INITIAL_SETTINGS — the settings clusters core still owns, at boot
 * values. Shrinks as clusters move out to the Layer fragments composed on top
 * of it.
 */
...
export const CORE_INITIAL_SETTINGS: CoreSettingsState = {
