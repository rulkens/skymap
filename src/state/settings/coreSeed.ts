/**
 * CORE_SEED — the settings clusters core still owns, at boot values; shrinks as
 * clusters move out to the Layer fragments composed on top of it.
 */
...
export const CORE_SEED: Omit<EngineSettingsState, 'galaxyCatalogs' | 'starCatalogs'> = {
