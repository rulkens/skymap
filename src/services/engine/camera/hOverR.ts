/**
 * hOverR — a world eye's altitude over a body, in radius units. Eye-based (FW-A),
 * never pivot-derived, and reuses `bodyRelativePose` — spec §10's one permitted
 * Mpc↔metre seam for the engaged camera path. The basis argument is discarded, so
 * any orthonormal matrix works.
 */
