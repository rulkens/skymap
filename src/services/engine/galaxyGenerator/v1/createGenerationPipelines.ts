 ...
 * import `galaxyGen/generate.wesl`'s shared bindings/helpers via WESL's
 ...
 * shaders declare the identical `@group(0)` bindings in `galaxyGen/generate.wesl`.
...
import generateStarsWgsl from '../../../gpu/shaders/galaxyGen/generateStars.wesl?static';
import generateDustWgsl from '../../../gpu/shaders/galaxyGen/generateDust.wesl?static';
