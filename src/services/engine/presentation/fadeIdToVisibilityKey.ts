  ...
  switch (h.kind) {
    ...
    case 'labelLayer': {
      switch (h.layer) {
        ...
        case 'body':
          // A per-item body caption (h.item) maps to the single `bodyLabel`
          // key, the same collapse the structure and star-catalog arms make: a
          // clip cue targeting the near-field captions fades every body's
          // together.
          return 'bodyLabel';
