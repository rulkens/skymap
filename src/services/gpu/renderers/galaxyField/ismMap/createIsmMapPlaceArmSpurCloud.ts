...
import { ARM_SPUR_CLOUD_RECORD_FLOATS, packArmSpurCloudRecords } from './packArmSpurCloudRecords';
...
import type { IsmMapPlaceArmSpurCloud } from '../../../../../@types/galaxy/IsmMapPlaceArmSpurCloud';
