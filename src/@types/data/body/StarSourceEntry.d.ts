...
/**
 * Star-typed row of the SOURCE_REGISTRY — the true-scale stellar neighbourhood
 * (the Sun plus the nearby-star map) in the near-field descent. A single seeded
 * collection (positions live in the body store, not this row), drawn by its own
 * content-layer.
 *
 ...
 */
export type StarSourceEntry = SourceEntryBase & {
  readonly type: 'star';
