 ...
 * integration boundary. `exposure` is a per-body look dial, not physics the
 * LUTs integrate; see `atmosphereParams.ts`.
 */
...
export type AtmosphereParams = {
  readonly planetRadiusKm: number; // ground sphere (Earth 6371, SCENE_EARTH.surface's inner bound)
