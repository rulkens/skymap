 ...
 * star resolves into a lit sphere sized from its `surface` datum (SI metres),
 * converted to draw space at render time.
 */
...
export type StarBody = {
  ...
  readonly surface: BodySurface; // used once resolved to a sphere (the Sun)
