 ...
 *  Rec.709 luma, then a peak-preserving normalisation if any channel now
 *  exceeds 1 (keeps hue on overflow rather than clipping it toward white),
 *  then `gamma` (`v^(1/gamma)`) after clamping to [0,1]. */
