 ...
 * so the snapshot taken before them (via captureScene) covers the full mutation
 * set and restoreScene returns the user's scene to exactly its pre-tour state.
 *
