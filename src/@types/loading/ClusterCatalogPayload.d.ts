...
/**
 * One entry of the `clusters_meta.json` sidecar — the string/identity fields
 ...
 *
 * Shape mirrors what `tools/clusters/buildClusters.ts` writes via its `toMeta`
...
/**
 * The decoded cluster-catalog asset: the numeric `.ccat` catalog paired with
