 ...
 * table so the thrown message stays legible — a typo in an authored `id` must
 * fail loudly wherever it is resolved, not silently seed a body at
 * `undefined`/NaN that only misbehaves much later.
 */
