...
// The five tuning anchors (SHADER_BAKED_NEAR_EXPOSURE, RAMP_NEAR_MPC,
// RAMP_MID_MPC, RAMP_FAR_MPC, RAMP_FAR_SCALE) live in `data/starExposureRamp.ts`
// as data, documented there; this file is the function alone.
import {
