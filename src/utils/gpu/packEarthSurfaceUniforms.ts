 ...
 * `debug.overlays['earth-lod-overlay']` DebugPanel toggle, as 0.0/1.0) therefore opens a
 ...
 * @param debugLodOverlay     `debug.overlays['earth-lod-overlay']` toggle — packed as
