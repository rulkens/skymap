/**
 * The site point in the HOST's body-fixed metres. Deliberately the same
 * expression `deriveBodyStates` places the rover with, off the same row and the
 * same ground radius: diverge and the rover drifts in frame as the camera moves.
 */
