 ...
 * sweeps scales with the pivot's radius, not altitude — 127 km over Earth a
 * flat-rate pixel sweeps ~350x the ground the screen actually spans, and the
 * `SURFACE_STANDOFF_RADII` floor sits far lower still.
 *
