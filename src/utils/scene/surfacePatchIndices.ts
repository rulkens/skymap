 ...
 * u=east, v=north, CCW-outward, matching the pipeline's `frontFace: 'ccw'`
 * + `cullMode: 'back'` — this template is now the sole definition of that
 * winding. `uint16` suffices — `(resolution+1)²` stays far under 65536 at
 * every resolution this plan uses.
 */
