 ...
 * floor clamp, the ceiling clamp, and the non-finite fallback where
 * applicable.
 */
...
describe('clampVolumeContrast clamps to [0.05, 16]', () => {
...
describe('clampVolumeIntensity clamps to [0, 1]', () => {
