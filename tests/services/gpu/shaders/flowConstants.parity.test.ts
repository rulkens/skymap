 ...
 * `flow/flowConstants.wesl` must equal the authoritative TS exports in
...
function parseWeslConstants(): Map<string, number> {
  const path = join(process.cwd(), 'src/services/gpu/shaders/flow/flowConstants.wesl');
...
describe('flowConstants.wesl ↔ flowFieldConstants.ts parity', () => {
