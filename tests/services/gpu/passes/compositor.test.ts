...
const TONE: ToneMap = { exposure: 1, curve: 1, hdrKneeStart: 0, hdrHeadroom: 0 };
...
describe('createCompositor', () => {
  ...
  it('tone set packs clamped exposure, curve, and toneEnabled=1', () => {
    ...
    c.draw(pass, SRC, 'replace', { exposure: 1e9, curve: 2, hdrKneeStart: 0, hdrHeadroom: 0 }, SWAP);
    ...
    c.draw(
      ...
      SRC,
      'replace',
      { exposure: 1e-9, curve: 2, hdrKneeStart: 0, hdrHeadroom: 0 },
      SWAP,
    );
