...
describe('collectPickTargets', () => {
  ...
  it('hasAny is false when no galaxy survey is masked-in and no cluster markers exist', () => {
  ...
  it('hasAny is TRUE on a cluster-only frame: no visible surveys but cluster markers present', () => {
