 ...
 * (drawMask bit), `slotState` (slot accessor + idle fallback), and `request`
 * (the transient request-flag set). `settings` is a direct passthrough and
 * needs no behaviour test.
 *
