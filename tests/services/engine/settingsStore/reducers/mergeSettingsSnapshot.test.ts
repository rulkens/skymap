...
import { mergeSettingsSnapshot } from '../../../../../src/services/engine/settingsStore/reducers/mergeSettingsSnapshot';
...
describe('mergeSettingsSnapshot', () => {
  ...
  it('merges all six clusters when given a full snapshot', () => {
    const state = makeSettingsFixture();
