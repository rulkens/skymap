...
// device.createBindGroupLayout.  The mock device returned by the gpuInitGpu
// mock is a plain object without WebGPU methods, so we mock the BGL
// factories directly instead of stubbing the device.
