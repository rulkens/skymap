 ...
 * full watcher set:
 *   watchTierSaga, watchWakeSaga, watchBiasBakeSaga, watchFadesSaga,
 *   watchSelectionRowsSaga, watchSelectionWakeSaga, watchRequestFocusSaga,
 *   watchFocusTweenSaga, watchTourSaga, watchClipSaga.
 */
