...
const SAMPLE_CSV = [
  ...
  // Valid galaxy: all numeric, z > 0, objID non-zero.
  '1237648720693788794,180.5,12.34,0.0512,19.21,18.05,17.40,17.10,16.92',
  // Invalid row: empty modelMag_u — should be skipped, not throw.
  '1237648720693788795,200.0,-5.0,0.10,,18.50,17.80,17.50,17.30',
].join('\n');
