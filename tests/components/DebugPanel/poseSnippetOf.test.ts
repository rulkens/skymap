...
// wrong pose into exhibitRegistry.ts — full precision, so the curator's
// stood-at target reads back exactly, not a rounded neighbour.
describe('poseSnippetOf', () => {
  it('formats a pose as an exhibitRegistry.ts-ready snippet, full precision', () => {
