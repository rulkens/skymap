...
import { createMilkyWayCloudRenderer } from '../../../../src/layers/milkyWay/render/milkyWayCloudRenderer';
...
describe('createMilkyWayCloudRenderer — the two entry points', () => {
  ...
  // offscreen, and vice versa. Their relative ORDER comes from FRAME_ORDER
  // plus the Layer's own `passes`, not this module's concern.
