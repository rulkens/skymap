...
describe('watchHashWriteSaga', () => {
  ...
  it('writes the pending id on requestFocus', () => {
  ...
  it('writes the resolved target on setSelectionRow', () => {
  ...
  it('writes an empty body on clearSelection', () => {
  ...
  it('writes t on any time-slice action, including one this file cannot name', () => {
    const store = buildHarness();
  ...
  it('does NOT write on commitCameraPose', () => {
