 ...
 *
 *   1. *Scope* — exactly the thirteen tour-owned clusters are captured, and
...
describe('captureSettings', () => {
  it('clones exactly the thirteen tour-owned clusters', () => {
    ...
    // The thirteen captured clusters deep-equal their source.
