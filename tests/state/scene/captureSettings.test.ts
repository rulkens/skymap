 ...
 *
 *   1. *Scope* — exactly the eleven tour-owned clusters are captured, and
...
describe('captureSettings', () => {
  it('clones exactly the eleven tour-owned clusters', () => {
    ...
    // The eleven captured clusters deep-equal their source.
